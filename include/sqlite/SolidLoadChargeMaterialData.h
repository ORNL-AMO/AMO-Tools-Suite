...
std::vector<SolidLoadChargeMaterial> SQLite::get_default_solid_load_charge_materials() {
    return {
        ...
        {"Die Casting Metal (Aluminum Alloy)", 0.236, 163, 0.241, 1150},
        {"Die Casting Metal (Lead Alloy)", 0.038, 17.5, 0.037, 600},
        {"Die Casting Metal (Tin Alloy)", 0.07, 30.2, 0.0621, 450},
        {"Die Casting Metal (Zinc Alloy)", 0.1029, 48, 0.138, 780},
