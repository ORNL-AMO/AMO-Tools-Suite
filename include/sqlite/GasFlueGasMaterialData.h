...
std::vector<GasCompositions> SQLite::get_default_gas_flue_gas_materials() {
    return {
		  ...
		  */
            {"Typical Natural Gas - US", 87, 8.5, 3.6, 0.4, 0, 0, 0, 0, 0.4, 0, 0.1, 22030.67089880065, 1032.45, 0.6571206283343215},
			{"Coke Oven Gas", 33.9, 5.2, 3.7, 47.9, 0, 0, 0, 6.1, 2.6, 0, 0.6, 19185.932389233436, 610.52, 0.44638781861292243},
		    {"Blast Furnace Gas", 0.1, 0, 56.4, 2.4, 0, 0, 3.4, 23.3, 14.4, 0, 0, 1080.6848266529887, 83.61, 1.0870540901007706},
    };
}
