...
public:
	...
	GasCompositions(const std::string & substance, const double CH4, const double C2H6, const double N2,
			...
			C3H8(std::make_shared<GasProperties>([] (double t = 0) { return 17.108; }, 44.094, 0.116589, C3H8,
			                   C3H8 / totalPercent, 160, 21669, 72.064, 132.03)),
			C4H10_CnH2n(std::make_shared<GasProperties>([] (double t = 0) { return 22.202; }, 58.12, 0.153675, C4H10_CnH2n,
			...
			SO2(std::make_shared<GasProperties>([] (double t = 0) { return 17.472; }, 64.06, 0.169381, SO2, SO2 * 100 / totalPercent,
			                  0, 0, 0, 0)),
