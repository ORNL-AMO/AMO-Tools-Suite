...
private:
	...
	const int o2Generated, heatingValue;
};
...
public:
	...
	gasCompositions(const double CH4, const double C2H6, const double N2, const double H2,
	                ...
	                const double combustionAirTemp, const double excessAir) :
	        ...
	        combustionAirTemp(combustionAirTemp),
	        excessAir(excessAir)
	{
		...
		calculateHeatCombustionAir();
		calculateHeatingValueFuel();
		calculateMassFlueGasComponents();
	}
	...
	gasCompositions( gasCompositions & comps ) :
			...
			combustionAirTemp(comps.combustionAirTemp), excessAir(comps.excessAir),
...
private:
	...
	void calculateSensibleHeat();
	void calculateHeatCombustionAir();
	void calculateHeatingValueFuel();
	void calculateMassFlueGasComponents();
	...
	const double totalPercent, combustionAirTemp, excessAir;
	double sensibleHeatFuel, heatCombustionAir, heatValueFuel;
	double mH2O = 0, mCO2 = 0, mO2 = 0, mN2 = 0;
