...
public:
	...
	public:
		...
		CostInfoOutput(double annualOperationSavings, double totalInstalledCostsPayback, double simplePayback,
					   double fuelCosts, double thermalCredit, double incrementalOandMDollarsKwH, double totalOperatingCostsToGenerate) : annualOperationSavings(annualOperationSavings),
