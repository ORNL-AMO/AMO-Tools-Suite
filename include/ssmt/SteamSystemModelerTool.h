...
//	};
     ...
     */
     double backwardPressureEnthalpyRegion1(const double pressure, const double enthalpy);
     ...
     * @return double, temperature in Kelvins
     */
    double backwardPressureEnthalpyRegion2A(const double pressure, const double enthalpy);


    double backwardPressureEnthalpyRegion2B(const double pressure, const double enthalpy);


    double backwardPressureEnthalpyRegion2C(const double pressure, const double enthalpy);
     ...
     * @return double, temperature in Kelvins
     */
    double backwardPressureEntropyRegion2A(const double pressure, const double entropy);


    double backwardPressureEntropyRegion2B(const double pressure, const double entropy);


    double backwardPressureEntropyRegion2C(const double pressure, const double entropy);
     ...
     * @return double, temperature in Kelvins
     */
    double backwardPressureEntropyRegion1(const double pressure, const double entropy);

    //double* generatePoint(int region, std::string key, double var1, double var2);


    //double linearTestPoint(const double x, double* point1, double* point2);
