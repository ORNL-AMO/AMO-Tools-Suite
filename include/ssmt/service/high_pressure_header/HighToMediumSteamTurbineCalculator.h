...
public:
    ...
    calc(const int headerCountInput, const SteamSystemModelerTool::FluidProperties &highPressureHeaderOutput,
         ...
         const std::shared_ptr<Turbine> &highToLowPressureTurbine, const PressureTurbine &highToMediumTurbineInput,
         const std::shared_ptr<HeaderNotHighestPressure> &mediumPressureHeaderInput,
         const std::shared_ptr<HeaderNotHighestPressure> &lowPressureHeaderInput, const Boiler &boiler) const;

private:
    Restarter restarter = Restarter();
    SteamReducer steamReducer = SteamReducer();
    ...
    checkSteamBalance(const SteamSystemModelerTool::FluidProperties &highPressureHeaderOutput,
                      ...
                      const std::shared_ptr<Turbine> &highToLowPressureTurbine,
                      const std::shared_ptr<HeaderNotHighestPressure> &lowPressureHeaderInput,
                      const Boiler &boiler, const std::shared_ptr<Turbine> &highToMediumPressureTurbine,
