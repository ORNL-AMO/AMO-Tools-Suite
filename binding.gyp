
{
  	"targets": [
		{
	    	"target_name": "phast",
	    	'include_dirs': ['include', 'include/calculator', 'include/phast', 'include/sqlite', 'third_party/sqlite',
	    	    "<!(node -e \"require('nan')\")"
	    	 ],
			'sources' : [
				'bindings/phast.cpp',
	    ...
	    {
	    	"target_name": "psat",
	    	'include_dirs': ['include', 'include/calculator', 'include/psat', 'include/sqlite', 'third_party/sqlite',
	    	    "<!(node -e \"require('nan')\")"
	    	 ],
			'sources' : [
				'bindings/psat.cpp',
