...
int main() {
    ...
    Pump pump(Pump::Style::API_DOUBLE_SUCTION, 1780, Pump::Drive::BELT_DRIVE, 1.00, 1.000, 1, Pump::Speed::NOT_FIXED_SPEED);
    ...
    FieldData fieldData(1840, 174.85, FieldData::LoadEstimationMethod::CURRENT, 80, 125.857, 480);
