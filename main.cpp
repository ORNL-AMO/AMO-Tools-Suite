...
int main() {
    ...
    Pump pump(Pump::Style::LARGE_END_SUCTION, 90, 1780, Pump::Drive::DIRECT_DRIVE, 1.00, 1.000, 2, Pump::Speed::NOT_FIXED_SPEED);
    Motor motor(Motor::LineFrequency::FREQ60, 100, 1780, Motor::EfficiencyClass::SPECIFIED, 95, 460, 225.0, 0);
