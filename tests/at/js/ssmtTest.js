...
function mapSteamModelerOutputToFlatArray(resultData) {
    let normalizedResultData = {
        ...
        ventedSteamOutput_pressure: resultData.lowPressureVentedSteam.pressure,
        ventedSteamOutput_temperature: resultData.lowPressureVentedSteam.temperature,
        ventedSteamOutput_specificEnthalpy: resultData.lowPressureVentedSteam.specificEnthalpy,
        ventedSteamOutput_specificEntropy: resultData.lowPressureVentedSteam.specificEntropy,
        ventedSteamOutput_quality: resultData.lowPressureVentedSteam.quality,
        ventedSteamOutput_specificVolume: resultData.lowPressureVentedSteam.specificVolume,
        ventedSteamOutput_massFlow: resultData.lowPressureVentedSteam.massFlow,
        ventedSteamOutput_energyFlow: resultData.lowPressureVentedSteam.energyFlow,
