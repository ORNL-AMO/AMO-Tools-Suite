...
function normalizeResultData(resultData) {
    let normalizedResultData = {
        operationsOutput_powerBalanceGeneration: resultData.operationsOutput.powerBalanceGeneration,
        operationsOutput_powerBalanceDemand: resultData.operationsOutput.powerBalanceDemand,
        operationsOutput_powerBalanceImport: resultData.operationsOutput.powerBalanceImport,
        operationsOutput_powerBalanceUnitCost: resultData.operationsOutput.powerBalanceUnitCost,
        operationsOutput_powerBalanceUnitCostPerYear: resultData.operationsOutput.powerBalanceUnitCostPerYear,
        operationsOutput_fuelBalanceBoiler: resultData.operationsOutput.fuelBalanceBoiler,
        operationsOutput_fuelBalanceUnitCost: resultData.operationsOutput.fuelBalanceUnitCost,
        operationsOutput_fuelBalanceUnitCostPerYear: resultData.operationsOutput.fuelBalanceUnitCostPerYear,
        operationsOutput_makeupWaterFlow: resultData.operationsOutput.makeupWaterFlow,
        operationsOutput_makeupWaterFlowRate: resultData.operationsOutput.makeupWaterFlowRate,
        operationsOutput_makeupWaterUnitCost: resultData.operationsOutput.makeupWaterUnitCost,
        operationsOutput_makeupWaterUnitCostPerYear: resultData.operationsOutput.makeupWaterUnitCostPerYear,
        operationsOutput_totalOperatingCostPerYear: resultData.operationsOutput.totalOperatingCostPerYear,
        operationsOutput_highPressureCost: resultData.operationsOutput.highPressureCost,
        operationsOutput_mediumPressureCost: resultData.operationsOutput.mediumPressureCost,
        operationsOutput_lowPressureCost: resultData.operationsOutput.lowPressureCost,
        ...
        feedwaterOutput_pressure: resultData.feedwater.pressure,
        feedwaterOutput_temperature: resultData.feedwater.temperature,
        feedwaterOutput_specificEnthalpy: resultData.feedwater.specificEnthalpy,
        feedwaterOutput_specificEntropy: resultData.feedwater.specificEntropy,
        feedwaterOutput_quality: resultData.feedwater.quality,
        feedwaterOutput_specificVolume: resultData.feedwater.specificVolume,
        feedwaterOutput_massFlow: resultData.feedwater.massFlow,
        feedwaterOutput_energyFlow: resultData.feedwater.energyFlow,

        blowdownOutput_pressure: resultData.blowdown.pressure,
        blowdownOutput_temperature: resultData.blowdown.temperature,
        blowdownOutput_specificEnthalpy: resultData.blowdown.specificEnthalpy,
        blowdownOutput_specificEntropy: resultData.blowdown.specificEntropy,
        blowdownOutput_quality: resultData.blowdown.quality,
        blowdownOutput_specificVolume: resultData.blowdown.specificVolume,
        blowdownOutput_massFlow: resultData.blowdown.massFlow,
        blowdownOutput_energyFlow: resultData.blowdown.energyFlow,

        condensateOutput_pressure: resultData.condensate.pressure,
        condensateOutput_temperature: resultData.condensate.temperature,
        condensateOutput_specificEnthalpy: resultData.condensate.specificEnthalpy,
        condensateOutput_specificEntropy: resultData.condensate.specificEntropy,
        condensateOutput_quality: resultData.condensate.quality,
        condensateOutput_specificVolume: resultData.condensate.specificVolume,
        condensateOutput_massFlow: resultData.condensate.massFlow,
        condensateOutput_energyFlow: resultData.condensate.energyFlow,
        ...
        highPressureProcessSteamUsageOutput_specificEnthalpy: resultData.highPressureProcessSteamUsage.specificEnthalpy,
        highPressureProcessSteamUsageOutput_specificEntropy: resultData.highPressureProcessSteamUsage.specificEntropy,
        highPressureProcessSteamUsageOutput_quality: resultData.highPressureProcessSteamUsage.quality,
        highPressureProcessSteamUsageOutput_specificVolume: resultData.highPressureProcessSteamUsage.specificVolume,
