...
TEST_CASE("Compressed Air Pressure Reduction Baseline", "[CompressedAirPressureReduction][Util]")
{
    std::vector<CompressedAirPressureReductionInput> compressedAirPressureReductionInputVec = {
        CompressedAirPressureReductionInput(false, 8640, 0.005, 500, 150, NULL)};
...
{
    std::vector<CompressedAirPressureReductionInput> compressedAirPressureReductionInputVec = {
        CompressedAirPressureReductionInput(true, 8640, 0.005, 500, 150, 100)};
...
TEST_CASE("Compressed Air Pressure Reduction Baseline List", "[CompressedAirPressureReduction][Util]")
{
    std::vector<CompressedAirPressureReductionInput> compressedAirPressureReductionInputVec = {
        CompressedAirPressureReductionInput(false, 8640, 0.005, 500, 150, NULL),
        CompressedAirPressureReductionInput(false, 8640, 0.005, 250, 150, NULL),
        CompressedAirPressureReductionInput(false, 8640, 0.005, 500, 120, 120),
        CompressedAirPressureReductionInput(false, 8640, 0.005, 450, 170, 100)};
...
{
    std::vector<CompressedAirPressureReductionInput> compressedAirPressureReductionInputVec = {
        CompressedAirPressureReductionInput(true, 8640, 0.005, 500, 150, 50),
        CompressedAirPressureReductionInput(true, 8640, 0.005, 250, 150, 89)};
