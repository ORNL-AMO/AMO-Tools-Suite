...
//     var results = bindings.CompressorsCalc(input);
//     results.percentagePower = results.percentagePower * 100;
//     t.equal(results.percentagePower, rnd(60.22), "% Power 1");
//     t.equal(rnd(results.powerCalculated), rnd(132), "Power Calculated 1");

//     input.computeFromVal = .6022;
//     //0 = Percent Power
//     input.computeFrom = 0;
//     var results = bindings.CompressorsCalc(input);
//     results.percentageCapacity = results.percentageCapacity * 100;
//     t.equal(rnd(results.percentageCapacity), rnd(10), "% Capacity 1");
//     t.equal(rnd(results.powerCalculated), rnd(132), "Power Calculated 2");
...
//     var results = bindings.CompressorsCalc(input);
//     results.percentagePower = results.percentagePower * 100;
//     t.equal(rnd(results.percentagePower), rnd(91.38), "% Power 2");
//     t.equal(rnd(results.powerCalculated), rnd(201.3), "Power Calculated 3");

//     input.computeFromVal = .9138;
//     //0 = Percent Power
//     input.computeFrom = 0;
//     var results = bindings.CompressorsCalc(input);
//     results.percentageCapacity = results.percentageCapacity * 100;
//     t.equal(rnd(results.percentageCapacity), rnd(90), "% Capacity 2");
//     t.equal(rnd(results.powerCalculated), rnd(201.3), "Power Calculated 4");
// });
...
//     var results = bindings.CompressorsCalc(input);
//     results.percentagePower = results.percentagePower * 100;
//     t.equal(rnd(results.percentagePower), rnd(63.70), "% Power 1");
//     t.equal(rnd(results.powerCalculated), rnd(54.4), "Power Calculated 1");

//     input.computeFromVal = .6370;
//     //0 = Percent Power
//     input.computeFrom = 0;
//     var results = bindings.CompressorsCalc(input);
//     results.percentageCapacity = results.percentageCapacity * 100;
//     t.equal(rnd(results.percentageCapacity), rnd(10), "% Capacity 1");
//     t.equal(rnd(results.powerCalculated), rnd(54.4), "Power Calculated 2");
...
//     var results = bindings.CompressorsCalc(input);
//     results.percentagePower = results.percentagePower * 100;
//     t.equal(rnd(results.percentagePower), rnd(101.52), "% Power 2");
//     t.equal(rnd(results.powerCalculated), rnd(86.7), "Power Calculated 3");

//     input.computeFromVal = 1.0152;
//     //0 = Percent Power
//     input.computeFrom = 0;
//     var results = bindings.CompressorsCalc(input);
//     results.percentageCapacity = results.percentageCapacity * 100;
//     t.equal(rnd(results.percentageCapacity), rnd(90), "% Capacity 2");
//     t.equal(rnd(results.powerCalculated), rnd(86.7), "Power Calaculated 4");
// });
