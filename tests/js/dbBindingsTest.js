...
//
//     var pump_example = {
//         manufacturer: "manufacturer1", model: "model1", type: "type1", serialNumber: "serialNumber1",
//         status: "status1",  pumpType: "pumpType1", radialBearingType: "radialBearingType1", thrustBearingType: "thrustBearingType1",
//         shaftOrientation: "shaftOrientation1", shaftSealType: "shaftSealType1", fluidType: "fluidType1", priority: "priority1",
//         driveType: "driveType1", flangeConnectionClass: "flangeConnectionClass1", flangeConnectionSize: "flangeConnectionSize1",
//         numShafts: 1, speed: 1, numStages: 1,  yearlyOperatingHours: 1, yearInstalled: 1,
//         finalMotorRpm: 1, inletDiameter: 1, weight: 1, outletDiameter: 1,
//         percentageOfSchedule: 1, dailyPumpCapacity: 1, measuredPumpCapacity: 1,
//         pumpPerformance: 1, staticSuctionHead: 1, staticDischargeHead: 1, fluidDensity: 1,
//         lengthOfDischargePipe: 1, pipeDesignFrictionLosses: 1, maxWorkingPressure: 1,
//         maxAmbientTemperature: 1, maxSuctionLift: 1, displacement: 1, startingTorque: 1,
//         ratedSpeed: 1, shaftDiameter: 1, impellerDiameter: 1, efficiency: 1,
//         output60Hz: 1, minFlowSize: 1, pumpSize: 1, outOfService: 1, id: 0
//     };
//
...
//     t.equal(motor1.manufacturer, motor2.manufacturer, 'Motors: manufacturer is ' + motor2.manufacturer);
...
//
// // 45? tests per call?
// function testPumpEqual(t, pump1, pump2) {
//     t.equal(pump1.manufacturer, pump2.manufacturer, 'Pumps: manufacturer is ' + pump2.manufacturer);
//     t.equal(pump1.model, pump2.model);
//     t.equal(pump1.type, pump2.type);
//     t.equal(pump1.serialNumber, pump2.serialNumber);
//     t.equal(pump1.status, pump2.status);
//     t.equal(pump1.pumpType, pump2.pumpType);
//     t.equal(pump1.radialBearingType, pump2.radialBearingType);
//     t.equal(pump1.thrustBearingType, pump2.thrustBearingType);
//     t.equal(pump1.shaftOrientation, pump2.shaftOrientation);
//     t.equal(pump1.shaftSealType, pump2.shaftSealType);
//     t.equal(pump1.fluidType, pump2.fluidType);
//     t.equal(pump1.priority, pump2.priority);
//     t.equal(pump1.driveType, pump2.driveType);
//     t.equal(pump1.flangeConnectionClass, pump2.flangeConnectionClass);
//     t.equal(pump1.flangeConnectionSize, pump2.flangeConnectionSize);
//     t.equal(pump1.numShafts, pump2.numShafts);
//     t.equal(pump1.speed, pump2.speed);
//     t.equal(pump1.numStages, pump2.numStages);
//     t.equal(pump1.yearlyOperatingHours, pump2.yearlyOperatingHours);
//     t.equal(pump1.yearInstalled, pump2.yearInstalled);
//     t.equal(pump1.finalMotorRpm, pump2.finalMotorRpm);
//     t.equal(pump1.inletDiameter, pump2.inletDiameter);
//     t.equal(pump1.weight, pump2.weight);
//     t.equal(pump1.outletDiameter, pump2.outletDiameter);
//     t.equal(pump1.percentageOfSchedule, pump2.percentageOfSchedule);
//     t.equal(pump1.dailyPumpCapacity, pump2.dailyPumpCapacity);
//     t.equal(pump1.measuredPumpCapacity, pump2.measuredPumpCapacity);
//     t.equal(pump1.pumpPerformance, pump2.pumpPerformance);
//     t.equal(pump1.staticSuctionHead, pump2.staticSuctionHead);
//     t.equal(pump1.staticDischargeHead, pump2.staticDischargeHead);
//     t.equal(pump1.fluidDensity, pump2.fluidDensity);
//     t.equal(pump1.lengthOfDischargePipe, pump2.lengthOfDischargePipe);
//     t.equal(pump1.pipeDesignFrictionLosses, pump2.pipeDesignFrictionLosses);
//     t.equal(pump1.maxWorkingPressure, pump2.maxWorkingPressure);
//     t.equal(pump1.maxAmbientTemperature, pump2.maxAmbientTemperature);
//     t.equal(pump1.maxSuctionLift, pump2.maxSuctionLift);
//     t.equal(pump1.displacement, pump2.displacement);
//     t.equal(pump1.startingTorque, pump2.startingTorque);
//     t.equal(pump1.ratedSpeed, pump2.ratedSpeed);
//     t.equal(pump1.shaftDiameter, pump2.shaftDiameter);
//     t.equal(pump1.impellerDiameter, pump2.impellerDiameter);
//     t.equal(pump1.efficiency, pump2.efficiency);
//     t.equal(pump1.output60Hz, pump2.output60Hz);
//     t.equal(pump1.minFlowSize, pump2.minFlowSize);
//     t.equal(pump1.pumpSize, pump2.pumpSize);
//     t.equal(pump1.outOfService, pump2.outOfService);
// }
//
...
//         output60Hz: 1, minFlowSize: 1, pumpSize: 1, outOfService: 1, id: 0
//     };
//     var pumps = bindings.selectPumps()
//     bindings.insertPump(obj);
//     mat = bindings.selectPumpById(bindings.selectPumps().length);
//     mat.manufacturer = 'updated';
//     bindings.updatePump(mat);
//     obj.manufacturer = 'updated';
//     testPumpEqual(t, obj, bindings.selectPumpById(bindings.selectPumps().length))
// });
//
//
