...
TEST_CASE("Water Reduction MeteredFlowData") {
...
TEST_CASE("Water Reduction VolumeMeterData") {
std::vector<WaterReductionInput> waterReductionInputVec = {
...
TEST_CASE("Water Reduction BucketMethodData") {
std::vector<WaterReductionInput> waterReductionInputVec = {
...
TEST_CASE("Water Reduction WaterOtherMethodData") {
std::vector<WaterReductionInput> waterReductionInputVec = {
