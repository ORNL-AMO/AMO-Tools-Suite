...
FanShaftPower::FanShaftPower(const double hi, const double efficiencyMotor, const double efficiencyVFD,
...
FanShaftPower::FanShaftPower(const double voltage, const double amps, const double powerFactorAtLoad,
                             const double efficiencyMotor, const double efficiencyVFD, const double efficiencyBelt,
                             const double sumSEF)
