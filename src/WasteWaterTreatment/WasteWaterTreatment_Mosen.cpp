...
int main()
{
    ...
    inputParameters.Temperature = 26;
    inputParameters.So = 280;
    inputParameters.Volume = 9;
    inputParameters.FlowRate = 28;
    inputParameters.InertVSS = 30;
    inputParameters.OxidizableN = 60;
    inputParameters.Biomass = 0.85;
    inputParameters.InfluentTSS = 150;
    inputParameters.InertInOrgTSS = 15;
    inputParameters.EffluentTSS = 11;
    inputParameters.RASTSS = 10000;
    inputParameters.MLSSpar = 3300;
    inputParameters.FractionBiomass = 0.1;
    inputParameters.BiomassYeild = 0.6;
    inputParameters.HalfSaturation = 60;
    inputParameters.MicrobialDecay = 0.1;
    inputParameters.MaxUtilizationRate = 8;
    inputParameters.MaxDays = 22;
    inputParameters.TimeIncrement = 0.5;

    inputParameters.OperatingDO = 1.2;
    inputParameters.Alpha = 0.84;
    inputParameters.Beta = 0.92;
    inputParameters.SOTR = 3;
    inputParameters.Aeration = 2100;
    inputParameters.Elevation = 100;
    inputParameters.OperatingTime = 24;
    inputParameters.TypeAerators = 3;
    inputParameters.Speed = 100;
    inputParameters.EnergyCostUnit = 0.09;
