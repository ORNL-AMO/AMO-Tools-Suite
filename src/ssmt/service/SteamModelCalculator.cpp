...
SteamModelCalculator::calc(const bool isBaselineCalc, const double baselinePowerDemand, const HeaderInput &headerInput,
    ...
    const std::string methodName = "SteamModelCalculator::calc: ";
    ...
    const std::shared_ptr<LowPressureHeaderCalculationsDomain> &lowPressureHeaderCalculationsDomain =
            lowPressureHeaderModeler.model(headerCountInput, highPressureHeaderInput, mediumPressureHeaderInput,
                                           ...
                                           condensingTurbineInput, boilerInput, blowdownFlashTank,
                                           highPressureHeaderCalculationsDomain,
    ...
    //TODO ensure using updated values
    ...
    if (lowPressureVentedSteamCalculationsDomain != nullptr) {
        ...
        //made by: MakeupWaterAndCondensateHeaderModeler -> MakeupWaterAndCondensateHeaderCalculator
        //updated by: PowerBalanceChecker -> LowPressureVentedSteamCalculator
        //used by: DeaeratorModeler
...
//    const Deaerator &deaeratorUpdated =
//            (lowPressureVentedSteamCalculationsDomain == nullptr) ? deaerator
//                                                                  : lowPressureVentedSteamCalculationsDomain->deaerator;
////    const double lowPressureVentedSteamUpdated =
////            (lowPressureVentedSteamCalculationsDomain == nullptr) ? lowPressureVentedSteam
////                                                                  : lowPressureVentedSteamCalculationsDomain->lowPressureVentedSteam;

//    const SteamSystemModelerTool::FluidProperties &makeupWaterAndCondensateHeaderOutputUpdated =
//            (lowPressureVentedSteamCalculationsDomain == nullptr) ? makeupWaterAndCondensateHeaderOutput
//                                                                  : lowPressureVentedSteamCalculationsDomain->makeupWaterAndCondensateHeaderOutput;
////    const double makeupWaterAndMassFlowUpdated =
////            (lowPressureVentedSteamCalculationsDomain == nullptr) ? makeupWaterAndMassFlow
////                                                                  : lowPressureVentedSteamCalculationsDomain->makeupWaterAndMassFlow;
//    const double makeupWaterVolumeFlowUpdated =
//            (lowPressureVentedSteamCalculationsDomain == nullptr) ? makeupWaterVolumeFlow
//                                                                  : lowPressureVentedSteamCalculationsDomain->makeupWaterVolumeFlow;


    //TODO ensure using latest of what it uses
