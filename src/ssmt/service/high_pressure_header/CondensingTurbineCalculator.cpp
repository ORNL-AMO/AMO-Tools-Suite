...
CondensingTurbineCalculator::calc(const CondensingTurbine &condensingTurbineInput,
    ...
    const std::string methodName = "CondensingTurbineCalculator::calc: ";
    ...
    if (condensingTurbineInput.isUseTurbine()) {
        ...
        const Turbine condensingTurbine = turbineFactory.make(highPressureHeaderOutput, condensingTurbineInput);
