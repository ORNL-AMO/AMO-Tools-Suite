...
int main()
{
    ...
    inputParameters.Temperature = 20;
    inputParameters.So = 200;
    inputParameters.Volume = 1;
    inputParameters.FlowRate = 1;
    inputParameters.InertVSS = 40;
    inputParameters.OxidizableN = 35;
    inputParameters.Biomass = 0.85;
    inputParameters.InfluentTSS = 200;
    inputParameters.InertInOrgTSS = 20;
    inputParameters.EffluentTSS = 8;
    inputParameters.RASTSS = 10000;
    inputParameters.MLSSpar = 3000;
    ...
    inputParameters.OperatingDO = 4.5;
    inputParameters.Alpha = 0.84;
    inputParameters.Beta = 0.92;
    inputParameters.SOTR = 2.7;
    inputParameters.Aeration = 150;
    inputParameters.Elevation = 200;
    inputParameters.OperatingTime = 24;
    inputParameters.TypeAerators = 1;
